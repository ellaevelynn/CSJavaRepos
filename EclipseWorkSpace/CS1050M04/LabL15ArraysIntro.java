...
// enter the names for students first, then enter grades for each student
	System.out.print("Enter the first names of each student in your class ");
	for (int index = 0; index < numberStudents; index++) {//start loop
      firstNames[index] = input.next();
    }//end loop
	System.out.print("the names of your students are "+firstNames[index]);
//Challenge: Create a method where you pass both arrays.
