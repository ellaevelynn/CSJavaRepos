 ...
 *  Description: Guided Exploration 01 (GuessNumber)    
...
{// start of class
	...
	//the class GuessNumber contains a method named main, this allows the program to begin executing statements from the main method
...
//prints in console the text in parenthesis as well as the correct number
			else if (guess > number)
			{
				System.out.println("Your guess is too high");
			}
//prints in console the text in parenthesis
			else
			{
				System.out.println("Your guess is too low");
			}
		}// end of if/else commands
//prints in console the text in parenthesis
		keyboardInput.close();
//must close keyboard input to prevent error message and potential for data leak
	}//end of main
}//end of class
